...
import './App.css';
const SessionsDashboard = lazy(() => import('./components/SessionsDashboard'));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'analytics' && (
          <div className="animate-fade-in">
            <Suspense fallback={<div className="flex items-center justify-center h-96"><div className="w-16 h-16 border-4 border-primary-600 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div><p className="text-slate-400">Loading dashboard...</p></div>}>
              <SessionsDashboard />
            </Suspense>
          </div>
        )}
